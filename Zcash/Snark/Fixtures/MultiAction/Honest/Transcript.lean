...
/-!
# Byte-level Fiat–Shamir check for the multi-action capture
...
schedule through BLAKE2b over halo2's transcript encoding reproduces all 22 captured challenges, with two actions' elements interleaved per proof. -/
