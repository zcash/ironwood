...
abbrev CircuitShape := Halo2.CircuitShape
...
def _root_.Halo2.CircuitShape.withProofParams (shape : CircuitShape) (pp : ProofParams) : Shape :=
...
@[simp] theorem _root_.Halo2.CircuitShape.withProofParams_numPermutationColumns
    (shape : CircuitShape) (pp : ProofParams) :
...
@[simp] theorem _root_.Halo2.CircuitShape.withProofParams_numQuotientPieces
    (shape : CircuitShape) (pp : ProofParams) :
...
@[simp] theorem _root_.Halo2.CircuitShape.withProofParams_numInstanceColumns
    (shape : CircuitShape) (pp : ProofParams) :
...
@[simp] theorem _root_.Halo2.CircuitShape.withProofParams_numInstanceQueries
    (shape : CircuitShape) (pp : ProofParams) :
