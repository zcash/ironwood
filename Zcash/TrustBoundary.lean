...
assert_axioms ComputedAlgebraicFSFamily.reductionEfficient_poly +native
assert_axioms ComputedAlgebraicFSFamily.FamilyForkSpread +native
assert_axioms ComputedAlgebraicFSFamily.reductionEfficient_of_forkSpread +native
...
assert_axioms ComputedAlgebraicFSFamily.knowledgeSoundness_under_DL_poly +native
assert_axioms ComputedAlgebraicFSFamily.cleanOpening +native
assert_axioms ComputedAlgebraicFSFamily.cleanOpening_isSome_iff +native
assert_axioms ComputedAlgebraicFSFamily.knowledgeSoundness_under_DL_computed +native
assert_axioms ComputedAlgebraicFSFamily.knowledgeSoundness_under_DL_computed_poly +native
assert_axioms ComputedAlgebraicFSFamily.binding_under_DL +native
assert_axioms ComputedAlgebraicFSFamily.binding_under_DL_poly +native
...
assert_axioms afkScanCharge
assert_axioms afkScanCharge_update
assert_axioms sum_afkScanCharge_le
assert_axioms OracleComp.run_update_eq_of_not_mem_queries
assert_axioms OracleComp.mem_queries_of_run_update_ne
assert_axioms OracleComp.card_filter_mem_queries_le
assert_axioms sum_steered_blind_mul_card
assert_axioms sum_steered_rank_stable_le
assert_axioms sum_steered_rank_abort_le
assert_axioms scanCandidateAt_runs_split
assert_axioms goodChallengesAt_stable
assert_axioms goodChallengesAt_nonempty_changed_query
assert_axioms sum_afkScanCharge_steered_le
assert_axioms recursiveAlgebraicForkFrom_tape_sum_runs_le_afk
assert_axioms recursiveAlgebraicForkFrom_oracle_tape_sum_runs_le_step
assert_axioms afkRunBound
assert_axioms recursiveAlgebraicForkFrom_oracle_tape_sum_runs_le_poly
assert_axioms recursiveAlgebraicFork_oracle_tape_sum_runs_le_poly
...
assert_axioms recursiveAlgebraicFork_oracle_tape_sum_runs_le_of_forkSpread
