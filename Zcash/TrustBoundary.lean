...
assert_computable Zcash.Snark.ActionTerminal.actionKnowledgeExtractor +choice +native(
  ...
  Zcash.Circuits.Ecc.MulFixed.Certs.valueCommitVCert_check,
  Zcash.Circuits.Ecc.MulFixed.Short.windowScalar_ne_zero)
-- Census the executable chosen-statement adaptive reduction end to end: its cached relation finder,
-- the finder projection, and the three Vesta outcome/extractor wrappers.
